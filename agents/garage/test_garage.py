"""Invoke the Garage Repair Checker supervisor endpoint and print the text output."""
import sys, json, requests
from databricks.sdk import WorkspaceClient

ENDPOINT = "mas-08625583-endpoint"
w = WorkspaceClient(profile="DEFAULT")
cfg = w.config
prompt = sys.argv[1] if len(sys.argv) > 1 else "Review claim CLM-B and tell me if the repair invoice is justified."
